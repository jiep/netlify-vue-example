...
.w-full.max-w-screen-xl.m-0.flex.flex-col.overflow-y-auto
  .bg-blue-600.text-white.w-full.p-4.text-center.flex-grow-0.select-none
    .flex.justify-between.items-center
      .flex-1
        .flex
          router-link.text-xl.font-bold(:to="{ name: 'iacr' }")
            svg.w-4.mr-2.text-white(role='img', xmlns='http://www.w3.org/2000/svg', viewBox='0 0 448 512')
        ...
        .flex-grow.flex.justify-between.content-center
          .flex.flex-col.flex-grow
            .flex.items-center.justify-between
              .shrink-0.flex
                p.text-lg.text-gray-900.font-sans.select-all Max papers
              .shrink-0.flex.ml-2
